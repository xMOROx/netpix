...
pub enum RtcpPacket {
    ...
    Goodbye(Goodbye),
    ApplicationDefined,
    PayloadSpecificFeedback(PayloadFeedback),
        ...
        match packet_type {
            ...
            PacketType::PayloadSpecificFeedback => {
                ...
                if let Some(pack) = packet.downcast_ref::<ReceiverEstimatedMaximumBitrate>() {
                    return RtcpPacket::PayloadSpecificFeedback(PayloadFeedback::ReceiverEstimatedMaximumBitrate(receiver_estimated_maximum_bitrate::ReceiverEstimatedMaximumBitrate::new(pack)));
                }
