...
impl<'a> TimestampReader<'a> {
    ...
    pub fn read_timestamp(&self) -> Result<u64, ()> {
        ...
        let ts_1 = ((self.reader.get_bits(0, 0x0E, 1).ok_or(())?) as u64) << 29;
        let ts_2 = (self.reader.get_bytes(1, 1).ok_or(())?[0] as u64) << 22;
        let ts_3 = ((self.reader.get_bits(2, 0xFE, 1).ok_or(())?) as u64) << 14;
    ...
    pub fn read_escr(&self) -> Result<(u64, u16), ()> {
        let base_1 = ((self.reader.get_bits(0, 0b00111000, 3).ok_or(())?) as u64) << 27;
        ...
        let base_4 = ((self.reader.get_bits(2, 0b11111000, 3).ok_or(())?) as u64) << 12;
