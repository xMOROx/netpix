...
implement_descriptor! {
    ...
    unmarshall_impl: |header, data| {
        ...
        Some(Mpeg4AudioDescriptor {
            header,
            audio_profile_and_level: reader.get_byte(0)?,
        })
    }
}
...
mod tests {
    ...
    fn test_mpeg4_video_descriptor_unmarshall() {
        ...
        let descriptor = Mpeg4AudioDescriptor {
            header: header.clone(),
            audio_profile_and_level: 0b1110_1000,
        };

        assert_eq!(
            Mpeg4AudioDescriptor::unmarshall(header, &data),
            Some(descriptor)
        );
    }
    ...
    fn test_mpeg4_video_descriptor_ne() {
        ...
        let descriptor2 = Mpeg4AudioDescriptor {
            header: header.clone(),
            audio_profile_and_level: 0b1110_1001,
        };
    ...
    fn test_should_display_mpeg4_video_descriptor() {
        ...
        assert_eq!(
            format!("{}", descriptor),
            "Mpeg4 Audio Descriptor\nAudio Profile And Level: 232\n"
        );
    }
}
